...
import org.sid.ebankingbackend.Exeption.BalanceNotSufficientException;
import org.sid.ebankingbackend.Exeption.BankAccountNotFoundException;
import org.sid.ebankingbackend.Exeption.CustomerNotFoundException;
...
CommandLineRunner commandLineRunner(BankAccountService bankAccountService) {
        return args -> {
            Stream.of("soso","koky","ahmed").forEach(name->{
